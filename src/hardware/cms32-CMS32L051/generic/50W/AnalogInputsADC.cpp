...
#include "Hardware.h"
#include "../../../../core/AnalogInputs.h"
#include "SMPS_PID.h"
extern "C" {
#include "../../cpu/CMSIS/StdDriver/inc/adc.h"
}
#include "imaxB6-pins.h"
#include "../../../../core/Utils.h"
#include "memory.h"
#include "Settings.h"
#include "../../../../core/AnalogInputsPrivate.h"
#include "../../cpu/IO.h"
#include "SMPS.h"
#include "Discharger.h"
#include "../../cpu/irq_priority.h"
extern "C" {
#include "../../cpu/CMSIS/StdDriver/inc/tim4.h"
}
#else
#include <stdint.h>
#include "atomic.h"
...
#define ADC_MODULE 0 // Dummy
#define CLK_EnableModuleClock(x) (void)x
#define CLK_SetModuleClock(x,y,z) (void)x
#define CLK_GetHCLKFreq() 64000000UL
#define CLK_CLKDIV_ADC(x) (x)
#define ADC_ADCR_DIFFEN_SINGLE_END 0
#define ADC_ADCR_ADMD_BURST 0
#define ADC_ADCR_DMOF_UNSIGNED_OUTPUT 0
#define ADC_ADF_INT 0
#define TMR1_MODULE 0
#define CLK_CLKSEL1_TMR1_S_HCLK 0
#define CLK_CLKDIV_UART(x) (x)
#define AD_TRG_TM01 0
#define TIMER_ONESHOT_MODE 1
#define TIMER1 TM4_CHANNEL_1
#define TMR1_IRQn TM01_IRQn
#define TMR1_IRQHandler TM01_Handler
#define ADC_IRQn ADC_IRQn
#define ADC_IRQHandler ADC_Handler
#define ADC_ADCR_VALID_Pos 0
#define ADC_ADDR_RSLT_Msk 0xFFF
#define ADC_ADDR_RSLT_Pos 0
#define ADC_ADSR_BUSY_Msk 0x80
#define ADC_ADCHER_PRESEL_Pos 0
#define ADC_ADCHER_PRESEL_EXT_INPUT_SIGNAL 0

#define ADC_IS_DATA_VALID2(adc, ch) (1)
#define ADC_GET_CONVERSION_DATA2(adc, ch) (adc->ADCR)
#define ADC_IS_BUSY2(adc) (0)

#define ADC_Open(adc, diff, mode, ch) ((void)0)
#define ADC_SET_DMOF(adc, mode) ((void)(mode))
#define ADC_POWER_ON(adc) ADC_Set_OperationOn()
#define ADC_CLR_INT_FLAG(adc, flag) ((void)(flag))
#define ADC_EnableInt(adc, flag) ((void)(flag))
#define ADC_SET_INPUT_CHANNEL(adc, ch) ((void)(ch))
#define ADC_START_CONV(adc) ((void)(adc))
#define ADC_STOP_CONV(adc) ADC_Stop()
#define ADC_CONFIG_CH7(adc, val) ((void)(val))
#define ADC_CONFIG_CH_SELECT(adc, ch) ((void)(ch))

#define TIMER_Open(tmr, mode, freq) ((void)(freq))
#define TIMER_EnableInt(tmr) ((void)(tmr))
#define TIMER_Start(tmr) TM40_Channel_Start((tm4_channel_t)tmr)
#define TIMER_ClearIntFlag(tmr) ((void)(tmr))

#define ANALOG_INPUT_DISCHARGE ANALOG_INPUT

struct SYS_temp { uint32_t TEMPCR; };
static SYS_temp dummy_sys;
#define SYS (&dummy_sys)


inline uint32_t inpw(volatile uint32_t* addr) { return *addr; }
