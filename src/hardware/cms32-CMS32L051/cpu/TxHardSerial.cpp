...
#include "../../cpu/CMSIS/StdDriver/inc/sci.h"
#else
#include "IO.h"
#endif
...
#define SYS_MFP_P31_Msk 0
#define SYS_MFP_P31_TXD0 0
#define SYS_MFP_P02_Msk 0
#define SYS_MFP_P02_TXD0 0
#define UART_BAUD_MODE2 0
#define UART_BAUD_MODE2_DIVIDER(a,b) 0
#define UART_WORD_LEN_8 0
#define UART_PARITY_NONE 0
#define UART_STOP_BIT_1 0
#define UART_IER_THRE_IEN_Msk 0
#define UART0_IRQn ST0_IRQn
#define UART0_IRQHandler ST0_Handler
#define UART_WRITE(u, d) UART0_Send(d)
#define UART_FSR_TE_FLAG_Msk 0x01 // Dummy
#define UART_FSR_TX_FULL_Msk 0x02 // Dummy
#define __HXT 0
...
static UART_Type dummy_uart0;
#define UART0 (&dummy_uart0)
