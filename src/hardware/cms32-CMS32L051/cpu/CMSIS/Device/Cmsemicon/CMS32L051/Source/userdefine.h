...
#define CNTLD   *((volatile uint16_t *)(0x40021C10)) /*!< (@ 0x40021C10) counter load value of wakeup time             */
...
//#define USE_SCI_SPI10         /*! Using CH2 of SCI0 as SPI Transmitter or Receiver */
    ...
    #error "Multi-functions declared of SCI02."
#endif
...
//#define USE_SCI_IIC11         /*! Using CH3 of SCI0 as IIC Transmitter or Receiver */
    ...
    #error "Multi-functions declared of SCI03."
#endif
...
#define INTP3_PORT_SETTING() do{ \
        PORT->INTP3PCFG = 0x1D;     /* allocate INTP3 to P70 */ \
        PORT->PM7  |=  (1 << 0);    /* P70 is used as INTP3 input */ \
        PORT->PMC7 &= ~(1 << 0);    /* P70 digital function */ \
}while(0)
