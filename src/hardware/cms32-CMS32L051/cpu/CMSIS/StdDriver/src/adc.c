...
* @brief  This function initializes the AD converter and initial all ANIxx pins to analog function.
*         Need to DELETE unused pin's setting in ADC_PORT_SETTING() by manually!
* @param  None
* @return None
***********************************************************************************************************************/
void ADC_Init(void)
