...
* @brief  This function initializes the UART0 module, start uart0 send/receive and disable interrupt.
...
MD_STATUS UART0_Init(uint32_t freq, uint32_t baud)
{
    ...
    SCI0->SPS0 = (0 << SCI0_SPS0_PRS00_Pos) | (0 << SCI0_SPS0_PRS01_Pos);
...
* @brief  This function initializes the UART1 module, start uart1 send/receive and enable the related interrupt.
*         Date Length: 8 bit; Parity: none; Stop: 1 bit              
* @param  freq - the frequency of fCLK
* @param  baud - the expected baud rate
...
* @brief  This function initializes the UART2 module, start uart2 send/receive and enable the related interrupt.
*         Date Length: 8 bit; Parity: none; Stop: 1 bit              
* @param  freq - the frequency of fCLK
* @param  baud - the expected baud rate
* @return status - MD_OK, MD_ERROR
...
MD_STATUS UART2_BaudRate(uint32_t fclk_freq, uint32_t baud)
{
    ...
    {
        SCI1->ST1 = _0002_SCI_CH1_STOP_TRG_ON | _0001_SCI_CH0_STOP_TRG_ON;
        SCI1->SPS1 &= ~SCI0_SPS0_PRS00_Msk;
        SCI1->SPS1 |= pvalue.prs;
